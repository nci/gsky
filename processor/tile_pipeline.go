...
func getFlexRaster(idx int, timestamp time.Time, req *GeoTileRequest, raster utils.Raster) (*FlexRaster, bool) {
	...
	flex := &FlexRaster{ConfigPayLoad: ConfigPayLoad{NameSpaces: req.ConfigPayLoad.NameSpaces}, NameSpace: namespace, TimeStamp: timestamp, Polygon: "dummy_polygon", Height: req.Height, Width: req.Width}

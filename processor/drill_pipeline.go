...
func (dp *DrillPipeline) Process(geoReq GeoDrillRequest, suffix string, templateFileName string, bandEval []string) chan string {
	...
	go i.Run()
	go grpcDriller.Run()
	go dm.Run(suffix, templateFileName, bandEval)
